...
// Registry
////////////////////////////////////////////////////////////////////////////////
// The registry manages the creation and construction of entities,
...
public:
    ...
    // Checks the component signature of an entity and add the entity to the system
...
void Registry::AddSystem(TArgs&& ...args)
{
    ...
    systems.insert(std::make_pair(std::type_index(type_id(TSystem)), newSystem));
}
